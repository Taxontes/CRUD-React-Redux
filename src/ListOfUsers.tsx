...
import { useAppSelector } from './hooks/tipadoHook'
import { useUser } from "./hooks/useUsers";


export function ListOfUsers() {
 
    //El users de state.users proviene del archivo index.ts, el nombre que se describa alli es el que se usara aqui
